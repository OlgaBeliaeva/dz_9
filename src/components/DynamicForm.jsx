  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className={styles.container}>
      <div className={styles.inputGroup}>
        <label htmlFor="firstField" className={styles.boldLabel}>First Field</label>
        <input
          id="firstField"
          name="firstField"
          type="text"
          ...
          className={`${styles.input} ${errors.firstField ? styles.errorInput : ''}`}
        />
      </div>
      ...
      {firstFieldValue && firstFieldValue.length >= 5 && (
        <div className={styles.inputGroup}>
          <label htmlFor="secondField" className={styles.boldLabel}>Second Field</label>
          <input
            id="secondField"
            name="secondField"
            type="text"
